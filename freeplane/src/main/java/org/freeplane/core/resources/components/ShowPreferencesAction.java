...
public class ShowPreferencesAction extends AFreeplaneAction {
	 ...
	 *
	 */
	public ShowPreferencesAction( final DefaultMutableTreeNode controls, boolean arePropertyValidatorsEnabled) {
		super(KEY);
	...
	public void actionPerformed(final ActionEvent e) {
		PreferencesDialogLauncher.open(controls,arePropertyValidatorsEnabled, e);
	}
