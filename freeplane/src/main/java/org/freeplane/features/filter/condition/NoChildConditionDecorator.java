 ...
 */
public class NoChildConditionDecorator extends DecoratedCondition implements ICombinedCondition{
	static final String DESCRIPTION = "filter_for_no_child";
    static final String NAME = "no_child_condition";
	...
	static ASelectableCondition load(final ConditionFactory conditionFactory, final XMLElement element) {
		...
		return cond == null ? null : new NoChildConditionDecorator(cond);
	}

	public NoChildConditionDecorator(final ASelectableCondition originalCondition) {
