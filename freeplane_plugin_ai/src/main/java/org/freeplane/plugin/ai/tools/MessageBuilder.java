...
public class MessageBuilder {
    ...
    private static final String ROLE_DEFINITION =
        "You are Freeplane AI Assistant, a specialized assistant for mind mapping tasks.\n"
            + "Your primary role is to help users create, expand, and manage mind maps effectively.\n"
            + "You have access to tools that can interact with the mind map directly.";
