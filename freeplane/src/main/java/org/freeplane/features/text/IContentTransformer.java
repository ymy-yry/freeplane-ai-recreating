...
public interface IContentTransformer extends Comparable<IContentTransformer> {
	...
	Object transformContent(NodeModel node, Object nodeProperty, Object content, TextController textController, Mode mode, Component component) throws TransformationException;
